...
async function loadAppointmentTypes() {
    try {
            const response = await fetch('https://dashboard.heroku.com/apps/eureka-server-ms/auth/appointment/admin-staff/fetchAllAppointmentType', {
            headers: {
...
async function loadAppointmentStatuses() {
    try {
            const response = await fetch('https://dashboard.heroku.com/apps/eureka-server-ms/auth/appointment/admin-staff/fetchAllAppointmentStatus', {
            headers: {
                'Authorization': `Bearer ${localStorage.getItem('token')}`
            }
        });
...
async function loadStaffList() {
    try {
            const response = await fetch('https://dashboard.heroku.com/apps/eureka-server-ms/auth/staff/admin-staff/fetchAllStaff', {
            headers: {
                'Authorization': `Bearer ${localStorage.getItem('token')}`
            }
        });
...
async function fetchAppointments(type, id) {
    let apiUrl = '';
    if (type === 'clientId') {
        apiUrl = `https://dashboard.heroku.com/apps/eureka-server-ms/auth/appointment/admin-staff/fetchByClientId?clientId=${id}`;
    } else if (type === 'staffId') {
        apiUrl = `https://dashboard.heroku.com/apps/eureka-server-ms/auth/appointment/admin-staff/fetchByStaffId?staffId=${id}`;
    }
...
async function fetchClientDetails(clientId) {
    try {
        const response = await fetch(`https://dashboard.heroku.com/apps/eureka-server-ms/auth/client/admin-staff/fetch?clientId=${clientId}`, {
            headers: {
                'Authorization': `Bearer ${localStorage.getItem('token')}`
            }
        });
...
async function fetchStaffDetails(staffId) {
    try {
        const response = await fetch(`https://dashboard.heroku.com/apps/eureka-server-ms/auth/staff/admin-staff/fetch?staffId=${staffId}`, {
            headers: {
                'Authorization': `Bearer ${localStorage.getItem('token')}`
            }
        });
...
async function fetchData() {
    ...
    if (dataType === 'client') {
        if (appointmentIdType === 'id') {
            apiUrl = `https://dashboard.heroku.com/apps/eureka-server-ms/auth/client/admin-staff/fetch?clientId=${dataId}`;
        } else if (appointmentIdType === 'email') {
            apiUrl = `https://dashboard.heroku.com/apps/eureka-server-ms/auth/client/admin-staff/fetchClientByEmail?email=${dataId}`;
        } else if (appointmentIdType === 'phone') {
            apiUrl = `https://dashboard.heroku.com/apps/eureka-server-ms/auth/client/admin-staff/fetchClientByPhoneNumber?phoneNumber=${dataId}`;
        } else if (appointmentIdType === 'all') {
            apiUrl = `https://dashboard.heroku.com/apps/eureka-server-ms/auth/client/admin-staff/fetchAllClients`;
        }
        showCreateButton = true; // Show create button for client data
    } else if (dataType === 'staff') {
        if (appointmentIdType === 'id') {
            apiUrl = `https://dashboard.heroku.com/apps/eureka-server-ms/auth/staff/admin-staff/fetch?staffId=${dataId}`;
        } else if (appointmentIdType === 'email') {
            apiUrl = `https://dashboard.heroku.com/apps/eureka-server-ms/auth/staff/admin-staff/fetchStaffByEmail?email=${dataId}`;
        } else if (appointmentIdType === 'phone') {
            apiUrl = `https://dashboard.heroku.com/apps/eureka-server-ms/auth/staff/admin-staff/fetchStaffByPhoneNumber?phoneNumber=${dataId}`;
        } else if (appointmentIdType === 'all') {
            apiUrl = `https://dashboard.heroku.com/apps/eureka-server-ms/auth/staff/admin-staff/fetchAllStaff`;
        }
    } else if (dataType === 'appointment') {
        if (appointmentSelection === 'single') {
            apiUrl = `https://dashboard.heroku.com/apps/eureka-server-ms/auth/appointment/admin-staff/fetch?appointmentNumber=${appointmentNumber}`;
        } else if (appointmentSelection === 'list') {
            if (appointmentListType === 'all') {
                apiUrl = `https://dashboard.heroku.com/apps/eureka-server-ms/auth/appointment/admin-staff/fetchAllAppointments`;
            } else if (appointmentListType === 'singleDate') {
                apiUrl = `https://dashboard.heroku.com/apps/eureka-server-ms/auth/appointment/admin-staff/fetchAppointmentsBySingleDate?date=${singleDate}`;
            } else if (appointmentListType === 'doubleDate') {
                apiUrl = `https://dashboard.heroku.com/apps/eureka-server-ms/auth/appointment/admin-staff/fetchAppointmentsByDoubleDates?date1=${startDate}&date2=${endDate}`;
            } else if (appointmentListType === 'status') {
                apiUrl = `https://dashboard.heroku.com/apps/eureka-server-ms/auth/appointment/admin-staff/fetchAppointmentsByAppointmentStatus?appointmentStatus=${appointmentStatus}`;
            } else if (appointmentListType === 'type') {
                apiUrl = `https://dashboard.heroku.com/apps/eureka-server-ms/auth/appointment/admin-staff/fetchAppointmentsByAppointmentType?appointmentType=${appointmentType}`;
            } else if (appointmentListType === 'today') {
                apiUrl = `https://dashboard.heroku.com/apps/eureka-server-ms/auth/appointment/admin-staff/fetchAppointmentsForToday`;
            } else if (appointmentListType === 'typeAndSingleDate') {
                apiUrl = `https://dashboard.heroku.com/apps/eureka-server-ms/auth/appointment/admin-staff/fetchAppointmentsByAppointmentTypeAndSingleDate?appointmentType=${appointmentType}&date=${singleDate}`;
            } else if (appointmentListType === 'typeAndDoubleDate') {
                apiUrl = `https://dashboard.heroku.com/apps/eureka-server-ms/auth/appointment/admin-staff/fetchAppointmentsByAppointmentTypeAndDoubleDates?appointmentType=${appointmentType}&date1=${startDate}&date2=${endDate}`;
            } else if (appointmentListType === 'statusAndSingleDate') {
                apiUrl = `https://dashboard.heroku.com/apps/eureka-server-ms/auth/appointment/admin-staff/fetchAppointmentsByAppointmentStatusAndSingleDate?appointmentStatus=${appointmentStatus}&date=${singleDate}`;
            } else if (appointmentListType === 'statusAndDoubleDate') {
                apiUrl = `https://dashboard.heroku.com/apps/eureka-server-ms/auth/appointment/admin-staff/fetchAppointmentsByAppointmentStatusAndDoubleDates?appointmentStatus=${appointmentStatus}&date1=${startDate}&date2=${endDate}`;
            } else if (appointmentListType === 'statusForToday') {
                apiUrl = `https://dashboard.heroku.com/apps/eureka-server-ms/auth/appointment/admin-staff/fetchAppointmentsByStatusForToday?appointmentStatus=${appointmentStatus}`;
            } else if (appointmentListType === 'typeForToday') {
                apiUrl = `https://dashboard.heroku.com/apps/eureka-server-ms/auth/appointment/admin-staff/fetchAppointmentsByTypeForToday?appointmentType=${appointmentType}`;
            } else if (appointmentListType === 'statusAndType') {
                apiUrl = `https://dashboard.heroku.com/apps/eureka-server-ms/auth/appointment/admin-staff/fetchAppointmentsByStatusAndTypeForToday?appointmentStatus=${appointmentStatus}&appointmentType=${appointmentType}`;
            }
        }
    }
...
async function updateClient() {
    ...
    const apiBaseUrlClient = 'https://dashboard.heroku.com/apps/eureka-server-ms/auth/client/admin';
...
async function updateStaff() {
    ...
    const apiBaseUrlStaff = 'https://dashboard.heroku.com/apps/eureka-server-ms/auth/staff/admin';
...
async function updateAppointment() {
    ...
    const apiBaseUrlAppointment = 'https://dashboard.heroku.com/apps/eureka-server-ms/auth/appointment/admin';
...
async function deleteData(type, id) {
    const apiBaseUrl = {
        client: `https://dashboard.heroku.com/apps/eureka-server-ms/auth/client/admin/delete?clientId=${id}`,
        staff: `https://dashboard.heroku.com/apps/eureka-server-ms/auth/staff/admin/delete?staffId=${id}`,
        appointment: `https://dashboard.heroku.com/apps/eureka-server-ms/auth/appointment/admin/delete?appointmentNumber=${id}`
    };
